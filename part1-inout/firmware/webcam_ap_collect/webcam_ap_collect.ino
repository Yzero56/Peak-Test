...
//
// Connect to WiFi "FridgeCam" (pw FridgeCamTest), open http://192.168.4.1
// XIAO ESP32S3 Sense + OV3660 (기본 OV2640 아님 — 방향 보정 포함). 포트: /dev/tty.usbmodem1101
#include <WiFi.h>
#include <WebServer.h>
...
void setup() {
  ...
  // 이 보드는 기본 OV2640이 아니라 OV3660으로 교체돼있어서(화각 우선),
  // 기본 방향이 뒤집혀 나온다 — camera_capture.ino에서 검증한 것과 동일한 보정.
  {
