...
URL: [https://wiki.seeedstudio.com/xiao_wifi_usage_esp32c6/](https://wiki.seeedstudio.com/xiao_wifi_usage_esp32c6/)
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/37.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/37.png))
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/38.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/38.png))
...
/*
  ...
  2. Point your web browser to [http://192.168.4.1/H](http://192.168.4.1/H) to turn the LED on or [http://192.168.4.1/L](http://192.168.4.1/L) to turn it off
  ...
  if (client) {                             // if you get a client,
    ...
    while (client.connected()) {            // loop while the client's connected
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        char c = [client.read](http://client.read)();             // read a byte, then
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/39.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/39.png))
...
The MQTT server address provided in the sample program is [`test.mosquitto.org`](http://test.mosquitto.org) , for testing purposes only. Please do not send any personal information to this address, as anyone can use this link to obtain your information.

![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/41.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/41.png))
...
- [Learn to use WiFiClient and HTTPClient on XIAO ESP32C3 - XIAO ESP32C3 &amp; ChatGPT in action]([https://wiki.seeedstudio.com/xiaoesp32c3-chatgpt](https://wiki.seeedstudio.com/xiaoesp32c3-chatgpt))

## WiFi Mesh

Accordingly to the [Espressif documentation]([https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-guides/mesh.html](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-guides/mesh.html)) :
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/42.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/42.png))
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/43.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/43.png))

The [painlessMesh library]([https://gitlab.com/painlessMesh/painlessMesh](https://gitlab.com/painlessMesh/painlessMesh)) allows us to create a mesh network with the ESP32 boards in an easy way.

![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/44.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/44.png))
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/45.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/45.png))

If this window doesn't show up, you'll need to install the following library dependencies:

- [ArduinoJson]([https://github.com/bblanchon/ArduinoJson](https://github.com/bblanchon/ArduinoJson)) (by bblanchon)

- [TaskScheduler]([https://github.com/arkhipenko/TaskScheduler](https://github.com/arkhipenko/TaskScheduler))

- [AsyncTCP]([https://github.com/me-no-dev/AsyncTCP](https://github.com/me-no-dev/AsyncTCP)) (ESP32)
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/46.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/46.png))
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/47.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/47.png))
...
![]([https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/48.png](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/48.png))
...
This article draws on the web content **[Random Nerd Tutorials]([https://randomnerdtutorials.com/](https://randomnerdtutorials.com/))** ' on ESP32 and uses it verified on the Seeed Studio XIAO ESP32C6.
...
- [ESP32 Useful Wi-Fi Library Functions (Arduino IDE)]([https://randomnerdtutorials.com/esp32-useful-wi-fi-functions-arduino/](https://randomnerdtutorials.com/esp32-useful-wi-fi-functions-arduino/))

- [ESP32 MQTT – Publish and Subscribe with Arduino IDE]([https://randomnerdtutorials.com/esp32-mqtt-publish-subscribe-arduino-ide/](https://randomnerdtutorials.com/esp32-mqtt-publish-subscribe-arduino-ide/))

- [ESP-MESH with ESP32 and ESP8266: Getting Started (painlessMesh library)]([https://randomnerdtutorials.com/esp-mesh-esp32-esp8266-painlessmesh/](https://randomnerdtutorials.com/esp-mesh-esp32-esp8266-painlessmesh/))
...
- [WiFi - Arduino Reference]([https://www.arduino.cc/en/Reference/WiFi](https://www.arduino.cc/en/Reference/WiFi))

- [Wi-Fi API - Arduino ESP32]([https://docs.espressif.com/projects/arduino-esp32/en/latest/api/wifi.html](https://docs.espressif.com/projects/arduino-esp32/en/latest/api/wifi.html))
