"""instance_dataset_prepared를 DINOv2 특징으로 바꾸고 개별 물건 분류기를 학습·평가한다."""
...
DATASET = ROOT / "instance_dataset_prepared"
MODEL_PATH = ROOT / "instance_classifier.joblib"
RESULT_PATH = ROOT / "instance_classifier_evaluation.json"
PREDICTIONS_PATH = ROOT / "instance_classifier_predictions.csv"
EMBEDDINGS_PATH = ROOT / "instance_classifier_embeddings.npz"
