...
2. Use an external pull-up resistor (optional if using the internal pull-up resistor).
3. Connect an LED to pin `D10` :
- Include a current-limiting resistor in series with the LED.
4. Include a current-limiting resistor in series with the LED.
