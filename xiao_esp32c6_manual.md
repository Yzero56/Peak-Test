...
| Product | XIAO ESP32-C6 | [XIAO ESP32-C3](https://www.seeedstudio.com/Seeed-XIAO-ESP32C3-p-5431.html ) | [XIAO ESP32-S3](https://www.seeedstudio.com/XIAO-ESP32S3-p-5627.html ) 
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/XIAO_ESP32-C6_back_pinout.png)
RF Switch
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/boards_url.png)

1. Download the XIAO ESP32C6 board package.
note
Only available if the version of the esp32 board is greater than `3.0.0` .

![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/install_board.png)

1. Opt for `XIAO_ESP32C6` variant.
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/select_xiao_c6.png)
Now enjoy coding ✨.
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/upload_program.png)
...
| ![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/XIAOC6_flash_firmware.png) | ![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/XIAOC6-blink.gif) 
...
![](https://files.seeedstudio.com/wiki/XIAO_WiFi/16.png)
